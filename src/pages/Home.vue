<template>
    <div>
        ...
        <div>
            ...
            <div id="content">
                <el-carousel :interval="3000" indicator-position="none" :height="bannerHeight+'px'"
                             style="width:1000px; margin-top:8%; margin-left: 23%; position:absolute">
...
<script>
    export default {
        ...
        data() {
            ...
            return {
                bannerHeight: "",
                imagesbox: [{id: 0, idView: require("../assets/no1.png")}, {
                    id: 1,
                    idView: require("../assets/no2.png")
                }],
                pinl: false,
                activeIndex: '1',
                backcolor: '#49dd84',
